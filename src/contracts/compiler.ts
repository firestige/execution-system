...
export function validateRunnerActivation(input: unknown): RunnerActivationContext {
  ...
  if (activation.schemaVersion !== "runner.activation@1.0.0" || activation.admission?.contractRevision !== "agentops.workflow-dsl@1.1.0" || activation.admission.deliveryAdmissionContractIdentity !== "agentops.delivery-admission@1.0.0" || !isSha256(activation.bindingIdentity) || activation.program === undefined || activation.initial === undefined || activation.correlation === undefined) {
