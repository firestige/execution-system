...
export type CustodyError = Readonly<{ code: "CORRELATION_MISMATCH" | "BASELINE_MISSING" | "GIT_STATE_MISMATCH" | "WORKSPACE_SNAPSHOT_CAPACITY_EXCEEDED" | "READ_VIEW_INVALID" | "PUBLICATION_GUARD_INVALID" | "RETIREMENT_NOT_AUTHORIZED" }>;
